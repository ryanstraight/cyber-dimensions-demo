...
- **[Introduction](docs/circuit-intro.html)**: Context, methodology, and learning framework
- **[Content](docs/circuit-content.html)**: Six authentic artifacts documenting the complete incident  
- **[Assignment](docs/circuit-assignment.html)**: Assessment framework with analysis questions
